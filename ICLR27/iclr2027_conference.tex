...
\centering
\caption{Zero-shot coverage (\%), leave-one-domain-out: each row's domain is
held out of training. E: the held-out domain's training-scale instances
(unseen); H: its test instances, up to an order of magnitude larger. Rand:
uniform choice among applicable actions under the same executor. --: not
measured.}
\label{table:main_table}
\resizebox{\linewidth}{!}{\begin{tabular}{@{}ll|c|ccc@{}}
\toprule
Held out & & Rand & \union{} & \gadarbind{} & \textbf{\gadar{}} \\
\midrule
\multirow{2}{*}{Blocks} & E & 1.7 & \todonum{--} & \todonum{--} & \todonum{--} \\
 & H & 0.2 & 0.0 & 1.0 & \textbf{3.0} \\
\midrule
\multirow{2}{*}{Gripper} & E & 0.0 & -- & \todonum{--} & \todonum{--} \\
 & H & 0.0 & -- & 0.0 & 0.0 \\
\midrule
\multirow{2}{*}{Miconic} & E & 88.3 & 0.0 & 0.0 & \textbf{36.0} \\
 & H & 1.1 & 0.0 & 0.0 & 0.0 \\
\midrule
\multirow{2}{*}{Visitall} & E & 99.7 & 0.8 & 16.0 & \textbf{100.0} \\
 & H & 6.0 & 0.0 & 4.0 & \textbf{68.0} \\
\midrule
\multirow{2}{*}{Grid} & E & 3.0 & 1.0 & 3.1 & \textbf{12.0} \\
 & H & 0.0 & 0.0 & 0.0 & \textbf{2.1} \\
\midrule
\multirow{2}{*}{Logistics} & E & 0.0 & \todonum{--} & \todonum{--} & \todonum{--} \\
 & H & 0.0 & 0.0 & 0.0 & 0.0 \\
\midrule
\multirow{2}{*}{Spanner} & E & 63.4 & \todonum{--} & \todonum{--} & \todonum{--} \\
 & H & 43.8 & 0.0 & 0.0 & 0.0 \\
\midrule
\multirow{2}{*}{Rovers} & E & 75.2 & \todonum{--} & \todonum{--} & \todonum{--} \\
 & H & 30.9 & 0.0 & 0.0 & 0.0 \\
\bottomrule
\end{tabular}}
\end{minipage}\hfill
...
\centering
\caption{In-domain coverage (\%) on the test instances. Ladder columns: mean
over the seven leave-one-out policies trained on the domain, each serving
seven domains. \gadar{}$_1$: trained on that domain alone.
GABAR$^\dagger$: published per-domain GABAR on its own test instances.}
\label{table:indomain}
\resizebox{\linewidth}{!}{\begin{tabular}{@{}l|c|ccc|c@{}}
\toprule
Domain & GABAR$^\dagger$ & \union{} & \gadarbind{} & \gadar{} & \gadar{}$_1$ \\
\midrule
Blocks    & 100.0 & 57.2 & 46.8 & 74.6 & 95.5 \\
Miconic   & 100.0 & 86.1 & 72.8 & 61.9 & 41.2 \\
Gripper   & 100.0 & 84.1 & 95.3 & 94.5 & 100.0 \\
Spanner   & 92.0  & 48.6 & 34.0 & 47.9 & 85.4 \\
Visitall  & 90.7  & 77.3 & 78.3 & 81.1 & 54.0 \\
Grid      & 96.3  & 89.6 & 59.4 & 94.6 & 87.5 \\
Logistics & 79.0  & 18.6 & 0.3 & 2.7  & 3.1 \\
Rovers    & 82.0  & 9.6 & 8.2 & 9.0  & 7.4 \\
\midrule
