...
\midrule
Blocks    & 100.0 & \todonum{--} & \todonum{--} & \todonum{--} & 74.6 & 95.5 \\
Miconic   & 100.0 & 99.2 & \todonum{--} & \todonum{--} & 61.9 & 41.2 \\
Gripper   & 100.0 & \todonum{--} & \todonum{--} & \todonum{--} & 94.5 & 100.0 \\
Spanner   & 92.0  & --           & \todonum{--} & \todonum{--} & 47.9 & 85.4 \\
Visitall  & 90.7  & --           & \todonum{--} & \todonum{--} & 81.1 & 54.0 \\
Grid      & 96.3  & --           & \todonum{--} & \todonum{--} & 94.6 & 87.5 \\
Logistics & 79.0  & --           & \todonum{--} & \todonum{--} & 2.7  & 3.1 \\
Rovers    & 82.0  & --           & \todonum{--} & \todonum{--} & 9.0  & 7.4 \\
\midrule
Mean      & 92.5  & \todonum{--} & \todonum{--} & \todonum{--} & 58.3 & 59.3 \\
\bottomrule
\end{tabular}
\end{table}

\textbf{Is the representation costly on its own? (\gadar{}$_1$ vs.\ GABAR.)}
Trained on a single domain, \gadar{}$_1$ solves 95.5\%, 100.0\%, and 41.2\%
of the Blocks, Gripper, and Miconic test instances, against \todonum{--}\%,
\todonum{--}\%, and 99.2\% for GABAR retrained through the same pipeline on
the same instances. Against published GABAR$^\dagger$ it is within five
...
while \union{}, which keeps the names, reaches \todonum{59.4}\% there.
...
were trained for \todonum{500} (Blocks), \todonum{N} (Gripper), and 500
(Miconic) epochs.
