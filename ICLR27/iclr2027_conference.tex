...
is held out of training and evaluated on its test instances, up to an order
of magnitude larger than training-scale problems. Rand: uniform choice among
applicable actions under the same executor and monitor (mean of three
rollouts). Untr: the identical system after one epoch of training. Ladder
columns add one group of components each: \union{} (symbol one-hots, domain
in the weights), \gadarbind{} (structural features, lifted domain layer,
binding edges), \gadar{} (chain layer, effect edges, goal features). P:
\gadar{}'s plan quality. GABAR$^\dagger$: published per-domain GABAR, trained
\emph{on} the domain and evaluated on its own test instances (not identical
to ours). --: not measured.}
\label{table:main_table}
\begin{tabular}{@{}l|cc|ccc|c|c@{}}
\toprule
Domain & Rand & Untr & \union{} & \gadarbind{} & \textbf{\gadar{}} & P & GABAR$^\dagger$ \\
\midrule
Blocks    & 0.2  & --  & 0.0 & 1.0 & \textbf{3.0} & -- & 100.0 \\
Gripper   & 0.0  & --  & --  & 0.0 & 0.0 & -- & 100.0 \\
Miconic   & 1.1  & --  & 0.0 & 0.0 & 0.0 & -- & 100.0 \\
Visitall  & 6.0  & \todonum{0.0} & \todonum{--} & \todonum{--} & \todonum{\textbf{68.0}} & \todonum{0.97} & 90.7 \\
Grid      & 0.0  & --  & 0.0 & 0.0 & 0.0 & -- & 96.3 \\
Logistics & 0.0  & --  & 0.0 & 0.0 & 0.0 & -- & 79.0 \\
Spanner   & 43.8 & --  & 0.0 & 0.0 & 0.0 & -- & 92.0 \\
Rovers    & 30.9 & --  & 0.0 & 0.0 & 0.0 & -- & 82.0 \\
\bottomrule
\end{tabular}
\end{table}
...
same representation trained on that domain alone.
...
\midrule
Blocks    & 100.0 & 57.2 & 49.8 & 74.6 & 95.5 \\
Miconic   & 100.0 & 86.1 & 68.4 & 61.9 & 41.2 \\
Gripper   & 100.0 & 84.1 & 94.9 & 94.5 & 100.0 \\
Spanner   & 92.0  & 48.6 & 31.7 & 47.9 & 85.4 \\
Visitall  & 90.7  & 77.3 & 78.3 & 81.1 & 54.0 \\
Grid      & 96.3  & 89.6 & 54.6 & 94.6 & 87.5 \\
Logistics & 79.0  & 18.6 & 0.4 & 2.7  & 3.1 \\
Rovers    & 82.0  & 9.6 & 8.3 & 9.0  & 7.4 \\
\midrule
Mean      & 92.5  & 58.9 & 48.3 & 58.3 & 59.3 \\
\bottomrule
\end{tabular}
\end{table}
...
either form clearly: one seven-domain model trains in \todonum{about 14}
hours on one GPU, while dedicated models take half an hour to two hours
