...
(\todonum{list the runs and their final epochs}). The \union{} and \gadarbind{} in-domain cells average the two or three
folds per domain whose in-domain evaluation completed before submission;
\gadar{} and \gadar{}$_1$ are complete. \gadar{}$_1$ uses the
