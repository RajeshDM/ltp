...
held out of training and evaluated on its test instances. Rand: uniform
choice among applicable actions under the same executor. --: not
measured.}
\label{table:main_table}
\resizebox{\linewidth}{!}{\begin{tabular}{@{}l|c|ccc@{}}
\toprule
Held out & Rand & \union{} & \gadarbind{} & \textbf{\gadar{}} \\
\midrule
Blocks    & 0.2  & 0.0 & 1.0 & \textbf{3.0} \\
Gripper   & 0.0  & --  & 0.0 & 0.0 \\
Miconic   & 1.1  & 0.0 & 0.0 & 0.0 \\
Visitall  & 6.0  & \todonum{--} & \todonum{--} & \todonum{\textbf{68.0}} \\
Grid      & 0.0  & 0.0 & 0.0 & 0.0 \\
Logistics & 0.0  & 0.0 & 0.0 & 0.0 \\
Spanner   & 43.8 & 0.0 & 0.0 & 0.0 \\
Rovers    & 30.9 & 0.0 & 0.0 & 0.0 \\
\bottomrule
\end{tabular}}
\end{minipage}\hfill
