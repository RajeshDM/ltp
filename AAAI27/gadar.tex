...
final setting. Training runs to a fixed budget listed in the appendix; one eight-domain
model takes seven to eight hours on a single NVIDIA A40, used for training
and testing alike. In-domain results use the checkpoint
