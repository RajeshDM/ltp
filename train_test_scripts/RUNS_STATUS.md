...
Cost: ~9-10 h train + ~12 h full test sweep per run (batch 64).
...
| 10 | `loo8_joint_chain_no_manyblocks` | train | TO LAUNCH | chain, table cell |
| 11 | `loo8_joint_chain_no_miconic` | train | TO LAUNCH | chain, table cell |
| 12 | `loo8_structural_no_manyblocks` | train_test | OPTIONAL | completes structural column |
| 13 | `loo8_structural_no_miconic` | train_test | OPTIONAL | completes structural column |
